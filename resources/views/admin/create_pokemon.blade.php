                            ...
                            <div class="card-body">
                                <form method="POST" action="/create_pokemon">
                                    ...
                                    <div class="form-group">
                                        <div class="form-row align-items-center">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input autocomplete="off" type="text" class="form-control" name="index" id="index" placeholder="001">
                                            </div>
                                            <div class="col-md-4 mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        <label for="sprite_3D_Shiny">Sprite 3D Shiny</label>
                                                        <div class="custom-file">
                                                            <input required type="file" class="custom-file-input"  name="Sprite_3D_Shiny" id="Sprite_3D_Shiny" onchange="imgChange('Sprite_3D_Shiny');">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-row align-items-center">
                                                        <div class="col-md-3 mb-3">
                                                            <label for="Sprite_3D_Mega">Sprite 3D Mega</label>
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"  name="Sprite_3D_Mega" id="Sprite_3D_Mega" onchange="imgChange('Sprite_3D_Mega');">
                                                                <label class="custom-file-label" for="Sprite_3D_Mega">Choose file</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <label for="sprite_3D_Mega_Shiny">Sprite 3D Mega Shiny</label>
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"  name="Sprite_3D_Mega_Shiny" id="Sprite_3D_Mega_Shiny" onchange="imgChange('Sprite_3D_Mega_Shiny');">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            <label for="sprite_3D">Sprite Form Gigamax Shiny</label>
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input"  name="Sprite_3D_Giga_Shiny" id="Sprite_3D_Giga_Shiny" onchange="imgChange('Sprite_3D_Giga_Shiny');">
                                                                <label class="custom-file-label" for="sprite_3D">Choose file</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-secondary" name="submit" id="submit"><img src="../../../img/pokeball_menu/Poke_Ball.png" alt="pokeball">CREATE !<img src="../../../img/pokeball_menu/Poke_Ball.png" alt="pokeball"></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <label style="font-weight: bold" for="Sprite_3D_Mega">Sprite 3D Mega :</label>
                                    <img id="Sprite_3D_MegaImg"/>
                                    <i class="fas fa-times" onclick="cancel('Sprite_3D_MegaImg');" id="Sprite_3D_MegaImg_cancel" style="color: red;cursor: pointer;" hidden></i>
                                    <br>

                                    <label style="font-weight: bold" for="Sprite_3D_Mega_Shiny">Sprite 3D_Mega Shiny :</label>
                                    <img id="Sprite_3D_Mega_ShinyImg"/>
                                    <i class="fas fa-times" onclick="cancel('Sprite_3D_Mega_ShinyImg');" id="Sprite_3D_Mega_ShinyImg_cancel" style="color: red;cursor: pointer;" hidden></i>
                                    <br>
